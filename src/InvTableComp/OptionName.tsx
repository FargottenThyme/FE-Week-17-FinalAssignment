...
export default function OptionName( { option, setOption, itemData, setItemData, resetUpdater }: Props ) {
    ...
    return (
        <div className="text-white">
            <input className="mar-left" type="radio"
                    value="Name" name="sort" checked={option === "Name"}
                    onChange={selectViewOption} /> Sort by Name <br />
        </div>
    )
}