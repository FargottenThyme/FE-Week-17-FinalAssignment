...
export default function OptionPrice( { option, setOption, itemData, setItemData, resetUpdater }: Props ) {
    ...
    return (
        <div className="text-white">
            <input className="mar-left" type="radio"
                    value="Price" name="sort" checked={option === "Price"}
                    onChange={selectViewOption} /> Sort by Price <br />
        </div>
    )
}